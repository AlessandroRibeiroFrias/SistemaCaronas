...
class CaronaMotoristaRepository {
   ...
   public function store($dados)
   {
    ...
    public function getMotoristaLivre($id_carona_caroneiro)
    {
        $retorno = DB::table('carona_motorista as cm')
          ...
          ->whereNotExists(function ($query) {
               ...
               ->whereColumn('s.carona_motorista_id', 'cm.id_carona_motorista')
               ->where('s.status_id', '=', 7);
          })
          ->get();
    ...
    public function updateStatusCaronaMotorista($id_carona_motorista, $status_id)
    {
          CaronaMotorista::where('id_carona_motorista', $id_carona_motorista)
